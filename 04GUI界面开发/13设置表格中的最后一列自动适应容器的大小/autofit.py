...
# Form implementation generated from reading ui file 'autofit.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setColumnWidth(0, 180)  # 设置第一列宽度
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "设置表格中的最后一列自动适应容器的大小"))
