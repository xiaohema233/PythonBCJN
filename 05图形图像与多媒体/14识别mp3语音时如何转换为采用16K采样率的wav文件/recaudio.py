...
APP_ID = 'XXX'  # 设置自己创建百度云应用时的ID
API_KEY = 'XXX'  # 设置自己创建百度云应用时的APIKey
SECRET_KEY = 'XXX'  # 设置自己创建百度云应用时的SECRETKey
...
# ffmpeg -i 5.mp4 -f wav -ar 16000 5.wav -y
cmd = "ffmpeg -i " + str(filepath) + " -ar 16000 -ac 1  -f wav " + newfile + " -y"
